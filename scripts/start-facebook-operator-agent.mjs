...
process.env.GROUP_MONITOR_SCHEDULER_MS ||= '30000';
...
console.log('Social Manager Facebook Operator Agent V1.6');
console.log('Browser mode: persistent local Chrome profile');
console.log('Group Monitor: ON (rate limit + chống trùng + chặn nội dung rủi ro).');
